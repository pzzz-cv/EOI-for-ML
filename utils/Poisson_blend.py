...
def Poisson_blend(imgTrg, imgSrc_gx, imgSrc_gy, holeMask, edge=None):
    ...
    Image.fromarray(raft_utils.flow_viz.flow_to_image(imgTrg)).save('/data4/pengzhan/CODE/optical_flow/FGVC-master/test.png')#unmasked
    Image.fromarray(raft_utils.flow_viz.flow_to_image(imgSrc_gx)).save('/data4/pengzhan/CODE/optical_flow/FGVC-master/test.png')#masked
    ...
    # Image.fromarray(utils.flow_viz.flow_to_image(imgRecon)).save('/data4/pengzhan/CODE/optical_flow/FGVC-master/test.png')
